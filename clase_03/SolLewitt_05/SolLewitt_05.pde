/*
 *   Arcs from the midpoint of four sides.
 *
 *                                                         Sol LeWitt
 */
...
void setup() {
  size(900, 600);
  smooth();
  beginRecord(PDF, "Sol LeWitt Wall Drawing 99.pdf");
  background(255);
}
...
void draw() {
  ...
  gridCircle(width/2, height, 120, 20);
  gridCircle(0, height/2, 120, 20);
  gridCircle(width, height/2, 120, 20);
