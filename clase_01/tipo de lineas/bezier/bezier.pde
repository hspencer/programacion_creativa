...
void setup(){
  ...
  for(int i = 0; i < numNodos; i++){
    ...
    float num = float(i)/3.0; // esto es para ver si i es múltiplo de tres
    if ((i/3) == num){
     nodos[i].col = #FF7040; // si es múltiplo de 3 significa que será un vértice, así que asígnele otro color
